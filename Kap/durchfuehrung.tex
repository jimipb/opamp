...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{Mess/Ekg/jonas_nofftfilters_gimp.pdf}
	\caption{Herzschlags nach Filterung}
	\label{jonfilter}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{Mess/Ekg/jonas_nofftnofilter_gimp.pdf}
	\caption{Zum Vergleich: selber Signalabschnitt ohne Filter}
	\label{jonnofilter}
\end{figure}
